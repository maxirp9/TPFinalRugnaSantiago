                  ...
                  <div class="col-md-12">
                      <div class="top-menu">
                                <ul class="nav pull-right top-menu">
                                    <li><a class="logout" href="empleados_alta.jsp">Crear Empleado</a></li>
                                </ul>
                      </div>
                      
                      <div class="content-panel">                          
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Lista de empleados</h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th>Apellido</th>
                              ...
                              <tbody>
                                  <%
                                      ...
                                      for (Empleado emple : listaEmpleados){
                                          if(emple.isActivo()==true){                                  
                                                                                
                                   %>
                              <tr>
                                  <td><%=emple.getApellido()%></a></td>
                                  <td><%=emple.getNombre()%></td>
                                  <td><%=emple.getEmail()%></a></td>
                                  <td><%=emple.getFechaNacimientoString()%></td>                                  
                                  <td>
